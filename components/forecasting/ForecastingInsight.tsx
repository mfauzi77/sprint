...
const ForecastingInsight: React.FC<ForecastingInsightProps> = ({ isLoading, insight, error, onRegenerate }) => {
        ...
        if (isLoading) {
            return (
                <div className="flex flex-col items-center justify-center h-48">
                    ...
                    <p className="mt-4 text-gray-600 text-sm">Menganalisis tren dan menghasilkan insight...</p>
                </div>
            );
        }
